...
extension UIView {
    ...
    func roundCornersWithRadius(_ radius: CGFloat, top: Bool? = true, bottom: Bool? = true,
                                shadowEnabled: Bool = true, shadowOffset: CGSize = CGSize(width: 4, height: 4),
    ...
    func setShadowPath(_ shadowOffset: CGSize = CGSize(width: 4, height: 4)) {
        let contactShadowSize = CGRect(x: layer.bounds.minX, y: layer.bounds.minY,
                                       width: layer.bounds.width + shadowOffset.width,
                                       height: layer.bounds.height + shadowOffset.height)
