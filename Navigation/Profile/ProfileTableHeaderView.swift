...
extension ProfileTableHeaderView {
    ...
    private func expand() {
        ...
        let topСloseButtonAnchor = self.closeButton.topAnchor.constraint(equalTo: rootSV.safeAreaLayoutGuide.topAnchor, constant: 10)
        topСloseButtonAnchor.identifier = "topСloseButtonAnchor"
        topСloseButtonAnchor.isActive = true
        
        let trailingСloseButtonAnchor = self.closeButton.trailingAnchor.constraint(equalTo: rootSV.safeAreaLayoutGuide.trailingAnchor)
